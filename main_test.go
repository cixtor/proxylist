...
func TestAnalyzeProxy53(t *testing.T) {
	ReportFailure(t, 53, Proxy{
		LastUpdate: "18h 54mins",
		Address:    "185.65.246.69",
		Port:       "8118",
		Country:    "France",
		Speed:      "89%",
		Connection: "100%",
...
func TestAnalyzeProxy54(t *testing.T) {
	ReportFailure(t, 54, Proxy{
		LastUpdate: "18h 59mins",
		Address:    "81.21.114.52",
		Port:       "9050",
		Country:    "Austria",
		Speed:      "100%",
		Connection: "100%",
...
func TestAnalyzeProxy55(t *testing.T) {
	ReportFailure(t, 55, Proxy{
		LastUpdate: "19h 28mins",
		Address:    "109.196.127.35",
		Port:       "8888",
		Country:    "Poland",
		Speed:      "100%",
		Connection: "100%",
